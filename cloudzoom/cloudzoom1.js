(function (e) {
  ...
  function m(a) {
    for (var b = '', c, g = B('charCodeAt'), d = a[g](0) - 32, e = 1; e < a.length - 1; e++) c = a[g](e),
    c ^= d & 31,
    d++,
  ...
  var r = window,
  C = r[m('9_ouiwpn&')], // >> function
  u = !0,
  D = !1,
  E = m('?QOUCST2'), // >> NOTAPP
  v = m('&RUAHF\\').length, // >> TRIAL
  z = !1,
  A = !1;
  5 == v ? A = !0 : 4 == v && (z = !0);
  d.ia = e(window).width();
  ...
  d.prototype.update = function () {
    ...
    null != a && (this.p(this.w, 0), this.f != this.i && (this.i += (this.f - this.i) / this.options.easing, 0.0001 > Math.abs(this.f - this.i) && (this.i = this.f), this.Ra()), a.update())
  };
  d.id = 0;
  ...
  d.prototype.F = function () {
    ...
    a.qa(a.b);
    if ((u || A || z) && 0) {
      b = e(m('+7hdx1,>vzb+I')); // >> <div></div>
      var f,
      c = '{}';
      A ? f = "Mice was here! hehehe!!"  : z && (f = m(')Jfdyi.U~3vl6dlxhkphyvnr,`kh ') /* >> Cloud Zoom by starplugins.com */, c = m('5n4uyzq|nrkqd,alhjt%2+);<=,#2s}appd5";ttrx<3"nrbglr~*3:%?pI')); /* >> {"background-color":"#000","border":"none","opacity":0.3} << */
      u && (f = m('+^bagluavp5U{wl~;FrqrF')); // >> Unlicensed Cloud Zoom
      b[m('0dtjg%')](f); // >> text
      // f = m('1j0c{fcqvt9&?}snnvp`$+*eomx/4-!!bk694uwmntq?$=41r{&)$}%`doiu,52 "#$%&54;lrot|vlhvz&?$qazci`h,#2u{`dywn:#8ypr}t"- `kiiu*3((jkh-<3fvla;dpx~tk?$=nnlf&)$agg~&jlcf|h0)6fwyk4i~ntx=,#dljq+taso)6/??`i0?6syyl4m~uzvk"; akib%$+zjhigaw3(1&en54;xtny{m"; 2t}&tgeco,.:? 3>1vtu|kunry3|ommq&?$$l9:)qO');
      // >> {"position":"absolute","left":"10px","bottom":"40px","z-index":"100000","visibility":"visible","display":"block","color":"#fff","text-shadow":"none","font-family":"sans-serif","font-size":"10px","font-weight":"bold","padding":"2px","border":"1px solid #400","background-color":"#d00"}
      ...
      b[m('2q`g)')](e[m(':jznn{USNL5')](f)); // >> css parseJSON
      b[m('2q`g)')](e[m(':jznn{USNL5')](c));
      b[m('%dvwmgn_c[')](l) // >> appendSelector
    }
  };
  ...
  d.Oa = function () {
    ...
    var a = new C('a', m('$mc.pagnd{#b`spfz{{8gjvntrr"=#djh`<%!{oy`/vp~`q.`vj9y&ys}pddWQMFijxfdnby&xyv|c;zx{xnrss0worvmehc.3h7j"~~cye:187?,~vh3j|l?b<28f9g)dldlxe5m;:;zr=u*%xAyAab|.rwawqtnfn"h"akawez><tMuE7v~rzjw+0+*98;%&+!jWoSsl<#2)(u9qw~~dRx7"/ (e^dZ#+$)%qr?-,/p:|xs}aU}4|E}]* -&,/um}yb,?4btfff{7\'$'));
    // [mice] >> if(window.location.protocol=="file:")return false;var c=encodeURIComponent(window.location.hostname);a=a.split(",");for(var b=0;b<a.length;b++)if(c==a[b]||c.substring(c.length-(a[b].length+1))==="."+a[b]||-1!==c.indexOf("."+a[b]+".")||0===c.indexOf(a[b]+"."))return!1;return!0
    if (5 != E.length) {
      var b = m('*gboh>? ?q|y;'); // >> mice000.com
      u = a(b)
    } else u = !1,
    d.Wa();
    this._ = '?Liugp>hodm9:;"nab0Davf/BEQXV;IN[M Mk`akub2G%J,Io{u+Sfs5&$49(+-(8' // >> Sites:mice000.com User:TRIAL USER License:N/A Date:Aug 03, 2015
  };
  d.Ua = function (a) {
